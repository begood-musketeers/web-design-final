...
if (!isset($_SESSION["user_id"]) && (!isset($_GET['p']) || ($_GET['p'] != "register" && $_GET['p'] != "login"))) {
  echo "
    <div role='alert' style='padding:20px;background:#ffff0033'>
      It looks like you haven't created an account yet. Please <a href='?p=register' style='color:#0000ff;text-decoration:underline'>create</a> an account to participate in XSN.
    </div>
  ";
}